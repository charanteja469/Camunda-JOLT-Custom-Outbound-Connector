...
> * [Connector Function](src/main/java/io/camunda/joltconnector/MyConnectorFunction.java) (rename, implement, update
...
1. Run `io.camunda.joltconnector.LocalConnectorRuntime` to start your connector.
